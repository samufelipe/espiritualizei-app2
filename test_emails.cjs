...
// Mock dos templates para teste rápido de visualização
const BRAND_COLOR = '#A78BFA';
const DARK_BG = '#15191E';
...
const welcomeContent = `
    <h1>Bem-vindo à sua nova jornada, Samuel!</h1>
...
fs.writeFileSync('preview_welcome.html', baseTemplate(welcomeContent, "Sua jornada espiritual começa agora."));
console.log("✅ Prévia gerada: preview_welcome.html");
