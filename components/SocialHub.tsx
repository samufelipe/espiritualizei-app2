    ...
    <div className="h-full flex flex-col bg-[#F8FAFC] dark:bg-brand-dark animate-fade-in font-sans overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden relative">
        <div className="max-w-4xl mx-auto w-full h-full flex flex-col">
           ...
           {activeSubTab === 'chat' && (
              <div className="flex-1 flex flex-col min-h-0 bg-slate-50/30 dark:bg-brand-dark relative animate-slide-up">
                 
                 <div ref={scrollRef} className="flex-1 overflow-y-auto min-h-0 px-4 sm:px-6 py-6 space-y-6 pb-4 no-scrollbar">
                    {loadingChat ? (
                 ...
                 <div className="shrink-0 px-4 py-4 bg-white dark:bg-brand-dark border-t border-slate-100 dark:border-white/10 pb-safe">
