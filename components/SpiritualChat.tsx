...
const SpiritualChat: React.FC<SpiritualChatProps> = ({ user }) => {
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-white dark:bg-brand-dark relative animate-fade-in transition-colors overflow-hidden">
      ...
      <div 
        className="flex-1 overflow-y-auto pt-12 pb-[220px] px-6 space-y-8 smooth-scroll relative z-10"
        role="log" 
        aria-live="polite" 
      ...
      <div className="fixed bottom-[88px] left-0 right-0 px-6 z-30 max-w-md mx-auto pb-safe">
