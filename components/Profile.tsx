  ...
  const renderField = (label: string, value: string | undefined, onChange: (val: string) => void, Icon: React.ElementType, placeholder: string, type: string = "text") => {
    ...
    return (
      <div className="bg-white/5 border border-white/10 rounded-2xl p-4 flex items-center gap-4 group">
	        <div className="flex items-center justify-center text-slate-500 shrink-0 group-hover:text-brand-violet transition-colors"><Icon size={28} /></div>
	           ...
	           <div className="flex items-center gap-2 mb-3 px-1">
                ...
                >
	              <div className="flex items-center gap-4">
			                 <div className={`flex items-center justify-center ${confession.color}`}>
			                    <Shield size={28} />
			                 </div>
	                 <div>
